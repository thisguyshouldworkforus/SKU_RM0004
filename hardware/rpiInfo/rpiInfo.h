...
/* When using CUSTOM_ADDRESS, set your NIC name here (e.g., "end0") */
#define CUSTOM_IFNAME    "end0"

/* Choose which interface’s IP to display */
#define IPADDRESS_TYPE   CUSTOM_ADDRESS   /* ETH0_ADDRESS | WLAN0_ADDRESS | CUSTOM_ADDRESS */
/**********Select display network IP type**************/

/************************IP display switch****************/
/* OPEN  -> show "hostname: ip"
 * CLOSE -> show HOSTNAME ONLY (uppercase) */
#define IP_DISPLAY_OPEN    0
#define IP_DISPLAY_CLOSE   1
#define IP_SWITCH          IP_DISPLAY_OPEN

/* Retained for compatibility; not shown when IP is disabled —
 * we dynamically substitute the UPPERCASE hostname instead. */
